...
cd "$FRONTEND_DIR"
npm ci
VITE_API_URL="/api/v1" VITE_PLATFORM_HOSTS="roteiroonline.com,www.roteiroonline.com,app.roteiroonline.com,localhost,127.0.0.1" npx vite build --mode admin --outDir dist-admin
