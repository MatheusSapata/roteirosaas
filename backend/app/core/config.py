...
class Settings(BaseSettings):
    ...
    viajechat_checkout_column_id: str | None = Field(None, alias="VIAJECHAT_CHECKOUT_COLUMN_ID")
    viajechat_checkout_column_name: str | None = Field(None, alias="VIAJECHAT_CHECKOUT_COLUMN_NAME")
    viajechat_checkout_lead_source: str | None = Field("Checkout Roteiro Online", alias="VIAJECHAT_CHECKOUT_LEAD_SOURCE")
    ...
    viajeon_provision_token: str | None = Field(None, alias="VIAJEON_PROVISION_TOKEN")
    viajeon_provision_secret: str | None = Field(None, alias="VIAJEON_PROVISION_SECRET")
    ...
    aerodatabox_rapidapi_host: str = Field("aerodatabox.p.rapidapi.com", alias="AERODATABOX_RAPIDAPI_HOST")
    aerodatabox_rapidapi_base_url: str = Field(
        "https://aerodatabox.p.rapidapi.com", alias="AERODATABOX_RAPIDAPI_BASE_URL"
    )
    aerodatabox_rapidapi_key: str | None = Field(None, alias="AERODATABOX_RAPIDAPI_KEY")
