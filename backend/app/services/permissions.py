...
PERMISSION_CATALOG: dict[str, PermissionDefinition] = {
    ...
    "leads_forms": PermissionDefinition("leads_forms", "Leads: Formularios", ("/api/v1/lead-forms",), "leads_forms", ("professional", "agency", "scale", "test"), "Professional"),
    ...
    "leads_settings": PermissionDefinition("leads_settings", "Leads: Configuracoes", ("/api/v1/lead-forms",), "leads_settings", ("professional", "agency", "scale", "test"), "Professional"),
    ...
    "pages": PermissionDefinition("pages", "Paginas", ("/api/v1/pages", "/api/v1/media"), "pages", ("professional", "agency", "scale", "test"), "Professional"),
    "pages_viewer": PermissionDefinition("pages_viewer", "Paginas: Visualizador", ("/api/v1/pages",), "pages_viewer", ("professional", "agency", "scale", "test"), "Professional"),
