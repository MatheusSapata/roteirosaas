        ...
        <div class="rounded-2xl bg-white p-4 shadow-md">
          <div class="flex flex-wrap items-center justify-between gap-3">
            <div class="flex flex-col gap-1">
              <h2 class="text-lg font-semibold text-slate-900">Preview visual (usando os mesmos componentes p�blicos)</h2>
              <p class="text-xs text-slate-500">Clique em Atualizar preview para aplicar as altera��es do formul�rio.</p>
            </div>
