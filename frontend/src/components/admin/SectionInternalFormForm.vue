    ...
    <main class="editor">
      ...
      <section v-if="activeTab === 'appearance'" class="card">
        ...
        <div class="body">
          ...
          <Field label="Cor do botão"><ColorInput v-model="local.buttonColor" /></Field>
        </div>
      </section>
