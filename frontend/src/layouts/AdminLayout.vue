...
const navIcons: Record<string, string> = {
  ...
  "/admin/aulas": '<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"><path d="M5 5.5A2.5 2.5 0 0 1 7.5 3H18a3 3 0 0 1 3 3v11.5A2.5 2.5 0 0 1 18.5 20H7.5A2.5 2.5 0 0 1 5 17.5z"/><path d="m12 11.25l4 2.25l-4 2.25z"/><path d="M5 7H4a2 2 0 0 0-2 2v8.5A2.5 2.5 0 0 0 4.5 20"/><path d="M5 10.5h5"/></g>' ,
